...
- **Calling the API in code?** See the [developers.md](/docs/developers) guide.
- **Wiring against the HTTP API?** See [api-reference.md](/docs/api-reference).
- **Looking at the web app?** See [interface.md](/docs/interface).
...
| [interface.md](/docs/interface) | The web app: the landing page, the onboarding flow, the dashboard tabs, and the Playground. |
...
| [developers.md](/docs/developers) | How to call the API: point your OpenAI client at Arbiter, set a budget, stream, manage your key, handle errors - with copy-paste examples. |

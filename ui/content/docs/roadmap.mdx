---
title: "Roadmap"
description: "What's next: hardening, smarter routing, wider reach."
---

This is an honest plan, not a wish list. It starts from the limitations the
current build already acknowledges (see [strategies.md](/docs/strategies) and
[integration.md](/docs/integration)) and orders work by impact, not by how
